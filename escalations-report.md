# Dev Escalations Report — 2026-02-26
...
| Pete's Garage Pending Payments | We did a Hotpatch recently to resolve two causes of Pending Payments, but unfortunately there have been more for PEGA. We have determined that these were being caused by Frictionless 3DS being enabled on our Adyen US account. US banks do not all support 3DS, so if we were always requesting it, those banks not supporting/engaging with it ultimately just produce pending payemtns. This rule was deactivated immediately when this was confirmed. Monitoring after-the-fact continues now. PEGA and other stakeholders are updated. | Monitoring | N/A |
| Checkout // Adyen Payments Pending - Improve Logging & add catch Adyen Webhook Middleware Error | We have discovered a new issue causing pending payments, related to an error getting config in Middleware. This Jira improves exception logging and adds a catch. Further work is being planned to resolve this. NB, this has not affected PEGA. | TBC | [CLECOM-11275](https://citruslime.atlassian.net/browse/CLECOM-11275) |
...
---
*Generated 2026-02-26 19:44 by Update-EscReport.ps1*
