...
| Checkout // Adyen Payments Pending - Improve Logging & add catch Adyen Webhook Middleware Error | We have discovered a new issue causing pending payments, related to an error getting config in Middleware. This Jira improves exception logging and adds a catch. Further work is being planned to resolve this. | TBC | [CLECOM-11275](https://citruslime.atlassian.net/browse/CLECOM-11275) |
